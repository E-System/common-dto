...
class PatcherSpec extends Specification {
    ...
    def "Rules all"() {
        when:
        DTO dto = new DTO("NAME", "NAME2", new DTOInternal(1), EntityCode.CODE.name())
        Entity entity = new Entity()
        Patcher.create(dto, entity, Arrays.asList("name", "name2", "role", "code"))
    ...
    static class DTO {
        ...
        DTO(String name, String name2, DTOInternal role, String code) {
            this.name = name
            this.name2 = name2
            this.role = role
            this.code = code
